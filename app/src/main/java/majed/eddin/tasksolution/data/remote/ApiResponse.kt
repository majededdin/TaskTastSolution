...
import majed.eddin.tasksolution.data.consts.Params.Companion.Errors
import majed.eddin.tasksolution.data.consts.Params.Companion.Message
            ...
            is HttpException -> {
                ...
                when (throwable.code()) {
                    ...
                    404 -> {
                        ...
                        ApiResponse(ApiStatus.OnNotFound)
                    }
